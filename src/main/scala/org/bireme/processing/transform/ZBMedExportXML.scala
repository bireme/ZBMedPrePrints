...
import org.bireme.processing.tools.models.{PPZBMedXml_Parameters, ZBMedpp_doc}
...
class ZBMedExportXML {
  ...
  private def processData(docsMongo: Seq[Map[String, AnyRef]], parameters: PPZBMedXml_Parameters, paramsWrite: mdwParameters, mExportRead: MongoDbReader, mExportWrite: MongoDbWriter): Try[Unit] = {
    Try {
